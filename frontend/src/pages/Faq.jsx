        ...
        <div className="mx-auto max-w-xl">
          <div className="relative">
            ...
            <input
              ...
              className="h-12 w-full rounded-xl border border-slate-200 bg-white pl-10 pr-4 text-sm text-slate-800 shadow-soft placeholder:text-slate-400 focus:border-brand-300 focus:outline-none focus:ring-2 focus:ring-brand-200"
            />
          </div>
        </div>
          ...
          {filteredFaqs.length === 0 ? (
            ...
            <Accordion type="single" collapsible className="space-y-3">
              {filteredFaqs.map((faq, i) => (
                <AccordionItem key={`${activeCategory}-${i}`} value={`faq-${i}`} className="rounded-2xl border border-slate-200 bg-white px-5 shadow-soft">
