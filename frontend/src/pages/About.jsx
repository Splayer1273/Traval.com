      ...
      <div className="container-x mt-10 space-y-14">
        ...
        <AnimateOnScroll preset="fadeUp">
          <div>
            ...
            <StaggerContainer className="mt-6 grid gap-5 sm:grid-cols-3" staggerDelay={0.1}>
              {VALUES.map((v) => (
                <StaggerItem key={v.title}>
                  <TiltCard maxTilt={4} scale={1.015}>
                    <div className="rounded-2xl border border-slate-200 bg-white p-6 text-center shadow-card transition-all hover:-translate-y-1 hover:shadow-lift">
                      <span className="mx-auto flex size-12 items-center justify-center rounded-full bg-gradient-to-br from-sun-100 to-amber-100 text-sun-600">
