...
const SECTIONS = [
  { h: '1. Acceptance of terms', p: 'By accessing or using the Project Sunrise website or app, you agree to be bound by these Terms & Conditions and our Privacy Policy. If you do not agree, please discontinue use of the platform.' },
  { h: '2. Booking services', p: 'Project Sunrise acts as an intermediary between travellers and airlines, hotels and tour operators. All bookings are subject to the terms, conditions and fare rules of the respective supplier, which are displayed before you confirm payment.' },
  ...
  { h: '6. Content & intellectual property', p: 'All content on the platform — including text, imagery, logos and software — is the property of Project Sunrise or its licensors and may not be reproduced without written consent.' },
  { h: '7. Limitation of liability', p: 'To the maximum extent permitted by law, Project Sunrise is not liable for indirect or consequential losses arising from supplier failures, force majeure events, or third-party acts beyond our reasonable control.' },
        ...
        <Card className="mx-auto max-w-3xl">
          <CardContent className="space-y-6 p-6 sm:p-8">
            <p className="leading-relaxed text-slate-600">
              Welcome to Project Sunrise Travel & Explore Pvt. Ltd. ("Project Sunrise", "we", "us"). These Terms govern your use
